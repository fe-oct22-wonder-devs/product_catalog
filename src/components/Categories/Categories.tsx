...
import phoneImg from '../../img/categoryImg/category-phones.png';
import tabletImg from '../../img/categoryImg/category-tablets.png';
import accessoriesImg from '../../img/categoryImg/category-accessories.png';
